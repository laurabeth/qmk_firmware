...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LOWER] = LAYOUT(
		...
		KC_TRNS, KC_PLUS, KC_EQL,  KC_MINS, KC_UNDS, KC_PIPE, KC_TRNS, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_PIPE,
		KC_CAPS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, SFT_SLS,
		         KC_VOLD, KC_MUTE, KC_VOLU, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_PGDN
	),
	[_RAISE] = LAYOUT(
		KC_TILD, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,  KC_8,  KC_9,  KC_0,    KC_DEL,
		KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_P4, KC_P5, KC_P6, KC_RBRC, KC_BSLS,
		KC_TRNS, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_P1, KC_P2, KC_P3, KC_NO,
		         KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, KC_TRNS, KC_NLCK, KC_NO, KC_NO
	),
    [_NAVIGATE] = LAYOUT(

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
		...
		KC_LCTL,  KC_LALT,                    KC_NO,   ENT_LOW,	      SPC_UPR,  KC_RALT,                          KC_RGUI, KC_RCTL
    ),
    ...
    [_GAMING] = LAYOUT(
		...
		KC_LCTL,  KC_LALT,                    MO(_RAISE), KC_SPC,	     KC_ENT,  KC_RALT,                          KC_RGUI, KC_RCTL
    ),
    ...
    [_ADJUST] = LAYOUT(
		KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,          KC_NO,   KC_NO,   KC_UP,   KC_NO,    KC_NO,   KC_NO,  KC_NO,
